...
- 최종 갱신: 2026-09-09
- 마지막 커밋: Phase 7 착수 — 읽기 전용 그래프 뷰어
- 테스트: `.venv\Scripts\python.exe -m pytest tests -q` → **119 passed**
...
**아직 없는 것**: 편집(드래그·배선·파라미터 수정), 실행 중 노드 상태 표시, Debug Output 패널,
History 되감기. 편집기는 이 뷰어 위에 얹는다.
